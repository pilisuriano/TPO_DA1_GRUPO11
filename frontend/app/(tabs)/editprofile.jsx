	...
	const navigation = useNavigation();
  	...
  	return (
    		<View style={styles.editProfile}>
      			...
      			<Text style={[styles.nombreCompleto, styles.gneroTypo]}>Nombre Completo</Text>
      			<Text style={[styles.gnero, styles.gneroTypo]}>Género</Text>
      			<Text style={[styles.descripcinDelPerfil, styles.gneroTypo]}>Descripción del perfil</Text>
      			<Pressable style={styles.rectangleParent} onPress={()=>{}}>
        				<View style={[styles.groupChild, styles.groupChildLayout]} />
        				<Text style={[styles.actualizar, styles.miPerfilTypo]}>Actualizar</Text>
      			</Pressable>
      			...
      			<Text style={[styles.imagenDePortada, styles.gneroTypo]}>Imagen de portada</Text>

...
import { Image, StyleSheet, Text, Pressable, View, ActivityIndicator } from "react-native";
...
const SEGUIDOS = () => {
  ...
  const { data: followers, loading, error } = useSelector((state) => state.followers.followers);
